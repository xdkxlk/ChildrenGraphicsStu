...
HisListWidget::HisListWidget(QWidget *parent) :
    QListWidget(parent)
{
...
void HisListWidget::contextMenuEvent(QContextMenuEvent* e)
{
...
void HisListWidget::mouseDoubleClickEvent(QMouseEvent *event)
{
...
void HisListWidget::Delete_clicked()
{
    emit Delete();
}

void HisListWidget::Login_clicked()
{
    emit Login();
}
